...
*N.B. I mostly use Copilot, but I also like to test these prompts out in ChatGPT and Google Gemini.*
...
Example: This prompt can use three different asynchronous methods.  
...
Example 1: Anyone can master this prompt in five minutes.  
...
Example 2: Many people benefit from this prompt.  
Incorrect revision: Many individuals benefit from this prompt.  
Correct revision: Many people benefit from this prompt.

Example 3: The individual elements of the prompt are generated by different functions.  
Incorrect revision: The elements of the prompt are generated by different functions.  
Correct revision: The individual elements of the prompt are generated by different functions.

### Actions to Perform

Act as a proofreader and technical editor. Ask me for a text. When you get it, perform the following tasks in order:
1. Revise the text:
    - Correct any typographical, grammatical, or punctuation errors.
